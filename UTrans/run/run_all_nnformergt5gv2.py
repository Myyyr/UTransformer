...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT5gv2', task='017', fold=1, outpath='NNFORMERGT5gv2Mep', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT5gv2', task='017', fold=1, outpath='NNFORMERGT5gv2Mep', val=True,  npz=True)
