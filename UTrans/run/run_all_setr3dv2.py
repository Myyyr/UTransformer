...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_Setr3dV2', task='062', fold=1, outpath='SETR3DV2', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_Setr3dV2', task='062', fold=1, outpath='SETR3DV2', val=True, npz=True)
