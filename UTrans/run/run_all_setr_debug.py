...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_setr3d_debug', task='062', fold=1, outpath='dbgSETR', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_setr3d_debug', task='062', fold=1, outpath='dbgSETR', val=True, npz=True)
