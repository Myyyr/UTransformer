...
g = '1'
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_nnFormerGT1', task='017', fold=1, outpath='2DNNFORMERGT1', val=False, npz=True)
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_nnFormerGT1', task='017', fold=1, outpath='2DNNFORMERGT1', val=True,  npz=True)
