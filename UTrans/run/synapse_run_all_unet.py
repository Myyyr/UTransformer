...
run.main(gpu='1', network='2d', network_trainer='nnUNetTrainerV2', task='17', fold=1, outpath='SynpaseUNET_v2', val=False, npz=True)
run.main(gpu='1', network='2d', network_trainer='nnUNetTrainerV2', task='17', fold=1, outpath='SynpaseUNET_v2', val=True, npz=True)
