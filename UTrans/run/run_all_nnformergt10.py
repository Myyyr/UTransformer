...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT10', task='017', fold=1, outpath='NNFORMERGT10', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT10', task='017', fold=1, outpath='NNFORMERGT10', val=True,  npz=True)
