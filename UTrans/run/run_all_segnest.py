...
run.main(gpu='1', network='2d', network_trainer='nnUNetTrainerV2_utrans_mhsa', task='062', fold=1, outpath='SEGNEST_V1', val=False, npz=True)
run.main(gpu='1', network='2d', network_trainer='nnUNetTrainerV2_utrans_mhsa', task='062', fold=1, outpath='SEGNEST_V1', val=True, npz=True)
