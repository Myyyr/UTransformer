...
g = '0'
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_unest3', task='062', fold=1, outpath='SEGNEST_V1', val=False, npz=True)
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_unest3', task='062', fold=1, outpath='SEGNEST_V1', val=True, npz=True)
