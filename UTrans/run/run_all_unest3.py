...
g = '0'
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_unest3', task='062', fold=1, outpath='unestv3ep500', ep=500, val=False, npz=True)
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_unest3', task='062', fold=1, outpath='unestv3ep500', ep=500, val=True, npz=True)
