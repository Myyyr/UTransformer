...
g = '2'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT5', task='017', fold=1, outpath='NNFORMERGT5', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT5', task='017', fold=1, outpath='NNFORMERGT5', val=True,  npz=True)
