...
g = '2'
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_iunest3', task='062', fold=1, outpath='iunestv3', val=False, npz=True)
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_iunest3', task='062', fold=1, outpath='iunestv3', val=True,  npz=True)
