...
g = '2'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_segnest3d', task='062', fold=1, outpath='SEGNEST3D', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_segnest3d', task='062', fold=1, outpath='SEGNEST3D', val=True, npz=True)
