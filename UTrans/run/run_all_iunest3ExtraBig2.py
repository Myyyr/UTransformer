...
g = '1'
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_iunest3ExtraBig2', task='062', fold=1, outpath='iunestv3ExtraBig2', val=False, npz=True)
run.main(gpu=g, network='2d', network_trainer='nnUNetTrainerV2_utrans_iunest3ExtraBig2', task='062', fold=1, outpath='iunestv3ExtraBig2', val=True,  npz=True)
