...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT1EXTV2', task='017', fold=1, outpath='NNFORMEREXTGT1V2', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT1EXTV2', task='017', fold=1, outpath='NNFORMEREXTGT1V2', val=True,  npz=True)
