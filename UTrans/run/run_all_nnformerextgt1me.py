...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT1EXTME', task='017', fold=1, outpath='NNFORMEREXTGT1me', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_nnFormerGT1EXTME', task='017', fold=1, outpath='NNFORMEREXTGT1me', val=True,  npz=True)
