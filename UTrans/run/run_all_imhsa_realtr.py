...
run.main(gpu='0', network='2d', network_trainer='nnUNetTrainerV2_utrans_imhsa_realtr', task='062', fold=1, outpath='MHSA_v4', val=False, npz=True)
run.main(gpu='0', network='2d', network_trainer='nnUNetTrainerV2_utrans_imhsa_realtr', task='062', fold=1, outpath='MHSA_v4', val=True, npz=True)
