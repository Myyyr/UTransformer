...
g = '2'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_utrans_segnest3d', task='062', fold=1, outpath='SEGNEST3D_V1', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_utrans_segnest3d', task='062', fold=1, outpath='SEGNEST3D_V1', val=True, npz=True)
