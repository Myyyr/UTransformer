...
g = '1'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_CoTR', task='062', fold=1, outpath='COTR', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_CoTR', task='062', fold=1, outpath='COTR', val=True, npz=True)
