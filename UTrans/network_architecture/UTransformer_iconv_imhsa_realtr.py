...
class UTransformer_imhsa(SegmentationNetwork):
...
class iMHSA(nn.Module):
    def __init__(self, d, n_heads = 8):
        ...
        self.self_trans = Transformer(dim=self.d, depth=6, heads=self.n_heads, dim_head=self.d//self.n_heads, mlp_dim=2048, dropout = 0.1)
