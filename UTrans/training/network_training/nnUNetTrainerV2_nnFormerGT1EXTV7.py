...
from UTrans.network_architecture.nnformergt_ext_v7 import swintransformer
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_nnFormerGT1EXTV7(nnUNetTrainer):

    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, vt_map=(3,5,5,1)):
    ...
    def initialize_network(self):
        ...
        self.network = swintransformer(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True,gt_num=1, vt_map=self.vt_map)
