...
from UTrans.network_architecture.generic_UNet import Generic_UNet
...
class nnUNetTrainerV2(nnUNetTrainer):
    ...
    def __init__(self, plans_file, orm_cfg=None, activation_cfg=None,fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
