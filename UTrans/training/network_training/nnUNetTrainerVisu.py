...
from UTrans.postprocessing.connected_components import determine_postprocessing
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def validate(self, idx=None, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
