...
from UTrans.network_architecture.nnformergt_good import swintransformer
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class brats_nnUNetTrainerV2_nnFormerGT1gv2(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = swintransformer(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True,gt_num=1, imsize=[128,128,128])
