...
from UTrans.network_architecture.neural_network_ext import SegmentationNetwork
from nnunet.training.data_augmentation.default_data_augmentation import default_2D_augmentation_params, \
    get_patch_size, default_3D_augmentation_params
from nnunet.training.dataloading.dataset_loading import unpack_dataset
from UTrans.training.network_training.nnUNetTrainerVisu import nnUNetTrainer
...
from UTrans.network_architecture.nnformergt_ext_v6_visu import swintransformer
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_nnFormerGT1EXTV6Visu(nnUNetTrainer):
    ...
    def validate(self, idx=None,do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        ret = super().validate(idx=idx,do_mirroring=do_mirroring, use_sliding_window=use_sliding_window, step_size=step_size,
