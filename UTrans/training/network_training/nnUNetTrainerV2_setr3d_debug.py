...
from UTrans.network_architecture.Setr3dV2 import Setr3d
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_setr3d_debug(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        :return:
        """
        self.network = Setr3d(norm_cfg=self.norm_cfg, activation_cfg=self.activation_cfg, img_size=self.plans['plans_per_stage'][1]['patch_size'],
