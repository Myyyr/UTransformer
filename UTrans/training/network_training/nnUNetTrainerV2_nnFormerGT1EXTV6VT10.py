...
from UTrans.network_architecture.nnformergt_ext_v6 import swintransformer
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_nnFormerGT1EXTV6VT10(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = swintransformer(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True,gt_num=1,vt_num=1)
